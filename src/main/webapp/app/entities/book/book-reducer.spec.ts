...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './book.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOOK_LIST actions', async () => {
    ...
    it('dispatches FETCH_BOOK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BOOK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BOOK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BOOK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BOOK actions', async () => {
      const expectedActions = [
        {
