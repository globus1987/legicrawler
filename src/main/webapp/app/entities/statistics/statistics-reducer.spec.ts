...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STATISTICS_LIST actions', async () => {
    ...
    it('dispatches FETCH_STATISTICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STATISTICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STATISTICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STATISTICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STATISTICS actions', async () => {
      const expectedActions = [
        {
