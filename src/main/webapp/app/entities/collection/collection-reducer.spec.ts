...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COLLECTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_COLLECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COLLECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COLLECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COLLECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COLLECTION actions', async () => {
      const expectedActions = [
        {
