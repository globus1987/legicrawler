...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_HISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HISTORY actions', async () => {
      const expectedActions = [
        {
