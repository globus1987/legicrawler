...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CYCLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CYCLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CYCLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CYCLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CYCLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CYCLE actions', async () => {
      const expectedActions = [
        {
