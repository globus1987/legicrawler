...
/**
 * REST controller for managing {@link com.arek.legicrawler.domain.Author}.
 */
@RestController
@RequestMapping("/api")
public class AuthorResource {
    ...
    public ResponseEntity<Author> updateAuthor(@PathVariable(value = "id", required = false) final String id, @RequestBody Author author)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, author.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Author> partialUpdateAuthor(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, author.getId()));
    }
